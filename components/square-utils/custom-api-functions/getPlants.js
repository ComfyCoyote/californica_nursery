...
async function getPlants(cursor, query=null, textFilter, limit){
    ...
    try{
        ...
        const archivedState = await getCatalogItemsAPI(PLANT_CATEGORY_ID, cursor, query, textFilter, limit)
