...
import { Plant, PriceVariation, SelectOption, AttributeSelection, AttributeSelectionMap, PlantAttributesAsArray, Seed } from "@/Interfaces/interfaces"
...
export const getServerSideProps : GetServerSideProps = async ({params}) => {
  ...
  try{
    ...
    data = {
        ...
        imageUrls: [],
        seedAttributes: plantAttributes
    } as Seed
